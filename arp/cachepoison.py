...
class ARPHandle(object):
    ...
    def spoof_arp(self):
        ...
        if cfg.ESPI_SPOOF_VERBOSITY:
            ...
            esp.print_babyshark_message("Sent ARP Request to: {} from: {} retrieving @ {}".format(self.target_address, self.gateway, host_mac_addr))
    ...
    def restore_network(self):
        ...
        if cfg.ESPI_SPOOF_VERBOSITY:
            esp.print_babyshark_noprefix("Restoring to: {} from: {} retrieving @ {}".format(self.target_address, self.gateway, mac_gateway))
